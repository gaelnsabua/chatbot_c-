...
\begin{titlepage}
    ...
    \vspace*{0.5cm}
    {\large Université Don Bosco de Lubumbasji}\\[0.2cm]
    {\normalsize Département Génie Logiciel}\\[0.2cm]
    ...
    \begin{center}
            \centering
            \vspace{2cm}
            \includegraphics[width=6cm]{logo_udbl.png}
            \vspace{1cm}
    \end{center}
    ...
    {\Large Tableau des membres du groupe}\\[0.3cm]
    \begin{center}
    ...
    \begin{center}
        ...
        \begin{tabularx}{1\textwidth}{|X|X|X|}
            ...
            \rowcolor{green!20}
            \textbf{Matricule} &
            \textbf{Nom \& Prénom} & \textbf{Sexe} \\
            \hline
            \textcolor{gray}{22MK275} &
            \textcolor{gray}{MUJINGA KYUNGU Guillain} &
            \textcolor{gray}{M} \\
            \hline
            \textcolor{gray}{22MN283} &
            \textcolor{gray}{MUKALA NSABUA Gael} &
            \textcolor{gray}{M} \\
            \hline
            \textcolor{gray}{22MK289} &
            \textcolor{gray}{MUKEBO KALASA Ruth} &
            \textcolor{gray}{F} \\
            \hline
            \textcolor{gray}{22MK291} &
            \textcolor{gray}{MUKEKWA KABAMBA Eliel} &
            \textcolor{gray}{M} \\
            \hline
            \hline
            \textcolor{gray}{22MK294} &
            \textcolor{gray}{MUKENDI KALOMBO Joel} &
            \textcolor{gray}{M} \\
            \hline
            \hline
            \textcolor{gray}{20MM381} &
            \textcolor{gray}{MUMBERE MWANGAZA David} &
            \textcolor{gray}{M} \\
            \hline
        \end{tabularx}
    \end{center}
